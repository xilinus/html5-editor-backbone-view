...
(function(/*! Stitch !*/) {
  ...
  exports.MainController = (function() {
    ...
    MainController.prototype.home = function() {
      return $('body').html(app.views.editor.render().el);
    };
    return MainController;
  })();
}).call(this);
}, "main": function(exports, require, module) {(function() {
  var Editor, EditorView, MainController;
  window.app = {};
  app.controllers = {};
  app.models = {};
  app.collections = {};
...
}, "models/editor": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.Editor = (function() {
    __extends(Editor, Backbone.Model);
    function Editor() {
      Editor.__super__.constructor.apply(this, arguments);
    }
    Editor.prototype.localStorage = new Store("app");
    return Editor;
  })();
}).call(this);
}, "templates/editor": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  ...
  (function() {
    (function() {
      __out.push('<div class="controls">\n  <input type="button" class="control_B" value="B"/>\n  <input type="button" class="control_I" value="I"/>\n  <input type="button" class="control_U" value="U"/>\n</div>\n<div class="message">\n</div>\n');
    }).call(this);
    
  }).call(__obj);
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/editor_view": function(exports, require, module) {(function() {
  var editorTemplate;
  ...
  exports.EditorView = (function() {
    ...
    EditorView.prototype.className = "editor";
    ...
    EditorView.prototype.initialize = function() {
      key('⌘+b, ctrl+b', this.bold);
      key('⌘+i, ctrl+i', this.italic);
      key('⌘+u, ctrl+u', this.underline);
      return $(this.el).delegate('.message', 'keyup', this.save);
    };
    EditorView.prototype.bold = function() {
      document.execCommand('bold', false, '');
      return false;
    };
    EditorView.prototype.italic = function() {
      document.execCommand('italic', false, '');
      return false;
    };
    EditorView.prototype.underline = function() {
      document.execCommand('underline', false, '');
      return false;
    };
    EditorView.prototype.save = function(event) {
      return this.model.set({
        text: this.$(".message").html()
      }).save();
    };
    EditorView.prototype.render = function() {
      $(this.el).html(editorTemplate());
      this.$(".message").html(this.model.get('text'));
      this.$(".message").attr('contenteditable', true);
      return this;
    };
    return EditorView;
  })();
